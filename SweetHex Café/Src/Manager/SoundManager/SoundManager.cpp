...
void SoundManager::Init(void)
{
	...
	seHandles_.emplace_back(
		LoadSoundMem((Application::PATH_DATA + "Sound/SE/AS_1424156_‚©‚í‚¢‚¢Œnƒ‚ƒ“ƒXƒ^[‚Ìƒpƒ“ƒ`‰¹.mp3").c_str()));

	seHandles_.emplace_back(
		LoadSoundMem((Application::PATH_DATA + "Sound/SE/AS_970270_‹i’ƒ“X‚âBar‚ÌƒJƒEƒxƒ‹“ü“XE‘Ş“X‰¹3.mp3").c_str()));

	seHandles_.emplace_back(
		LoadSoundMem((Application::PATH_DATA + "Sound/SE/AS_850615_ƒLƒƒƒbƒ`^•ß‚Ü‚¦‚é^‚Ò‚å‚±‚Á.mp3").c_str()));
